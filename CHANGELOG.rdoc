...
* Enhancements
  ...
  * Form navigation now uses a left menu
  ...
  * Add Scale variable type that allows options to be shared across other scale variables
    * Grouping scale variables with the same options on a design will group the options together in a table format
