...
* Enhancements
  * Units now available for numeric and integer variables
  ...
  * Designs can be split across multiple pages by setting "break before" to true on a section
  * Grid variable added that can display a list of variables in a grid format
    ...
    * Variable control sizes can be defined for grid variables
