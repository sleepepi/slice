...
* Enhancements
  * Design index now sorts by project name and creator name
  * Sheet index now sorts by design name, subject code, site name, project name, and creator name
  * Design index displays variable count per design
  * Project show page sheet and subject counts now link to the corresponding filtered sheet or subject index pages
  * Project logos can be removed from the project show page
  ...
  * Sheet Receipt emails can now optionally include an attached PDF of the sheet
  ...
  * Design sections and variables can be reordered on the design show page
  * Users can specify how many items are displayed on index pages
  * Advanced branching logic can now be added to variables and sections on designs
  * Data dictionaries in CSV format can now be downloaded by filtering designs
  * Design data dictionaries can be individually downloaded
  * Design show page now includes section and variable counts
