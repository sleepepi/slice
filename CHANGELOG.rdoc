...
* Enhancements
  ...
  * Design reports can be exported to PDF
  * Report permalinks specify to right click and copy link address
  ...
  * Design reports can be rendered in portrait (default) or landscape mode
  ...
  * Design reports can now specify to only view reports for the first or last entered sheet for a subject
