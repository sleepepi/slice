...
* Enhancements
  ...
  * Detailed sheet information added to popup on the sheets show page
  * New users can now be added to projects by email
  * Design Changes
    * Email subjects can be configured
  ...
  * Project Changes
    * Added reports that show the overall distribution of sheets by design and study date
    * Design reports allow column stratification by Study Date or any dropdown, radio, or string variable on the design
    * Reports now include permalinks to allow report configurations to be shared
    * Design reports can be downloaded to CSV
    * Project reports can drill down to the design level to view
      * Sheet distribution by site
      * Sheet distribution by any dropdown, radio, or autocomplete string variables on the design
...
* Bug Fix
  ...
  * Date and Time fields now display properly in grid views
