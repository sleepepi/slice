...
class ExportTest < ActiveSupport::TestCase
  ...
  test "generate a grid export with rows for each grid row" do
    ...
    assert_equal "863765097,Includes a Grid Variable,Test for grid variable saving,2014-11-25,Project One,Site One,Code01,,valid,FirstName LastName,,,1,/grids/941303609/response_file/rails.png,econ101,1.5,70.0,31.11,25,43199", rows[2]
    assert_equal "863765097,Includes a Grid Variable,Test for grid variable saving,2014-11-25,Project One,Site One,Code01,,valid,FirstName LastName,,,2,\"\",\"\",2.6,80.0,11.83,36,43200", rows[3]
