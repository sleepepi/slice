...
class StratificationFactorsControllerTest < ActionController::TestCase
  ...
  test 'should show stratification factor' do
    ...
    get :show, params: {
      project_id: @project,
      randomization_scheme_id: @randomization_scheme, id: @stratification_factor
    }
    assert_response :success
  end
  ...
  test 'should not show stratification factor with invalid randomization scheme' do
    ...
    get :show, params: {
      project_id: @project,
      randomization_scheme_id: -1, id: @stratification_factor
    }
  ...
  test 'should not show stratification factor with invalid stratification factor' do
    ...
    get :show, params: {
      project_id: @project,
      randomization_scheme_id: @randomization_scheme, id: -1
    }
