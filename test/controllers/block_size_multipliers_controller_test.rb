...
class BlockSizeMultipliersControllerTest < ActionController::TestCase
  ...
  test 'should get new' do
    get :new, params: { project_id: @project, randomization_scheme_id: @randomization_scheme }
    assert_response :success
  end

  test 'should not get new for published randomization scheme' do
    get :new, params: { project_id: @project, randomization_scheme_id: @published_scheme }
  ...
  test 'should show block size multiplier' do
    get :show, params: { project_id: @project, randomization_scheme_id: @randomization_scheme, id: @block_size_multiplier }
    assert_response :success
  end

  test 'should get edit' do
    get :edit, params: { project_id: @project, randomization_scheme_id: @randomization_scheme, id: @block_size_multiplier }
    assert_response :success
  end

  test 'should not get edit for published randomization scheme' do
    get :edit, params: { project_id: @project, randomization_scheme_id: @published_scheme, id: @published_block_size_multiplier }
    assert_redirected_to project_randomization_scheme_block_size_multiplier_path(
      assigns(:project), assigns(:randomization_scheme), assigns(:block_size_multiplier)
    )
  end
