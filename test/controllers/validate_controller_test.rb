...
class ValidateControllerTest < ActionController::TestCase
  test 'should validate variable' do
    xhr :post, :variable, project_id: projects(:one), variable_id: variables(:date), value: { month: '1', day: '1', year: '2000' }, format: 'json'
  ...
  test 'should validate variable with blank fields' do
    xhr :post, :variable, project_id: projects(:one), variable_id: variables(:date), value: { month: '', day: '', year: '' }, format: 'json'
  ...
  test 'should validate return out of range for variable' do
    xhr :post, :variable, project_id: projects(:one), variable_id: variables(:date), value: { month: '12', day: '31', year: '1989' }, format: 'json'
  ...
  test 'should validate return invalid for variable' do
    xhr :post, :variable, project_id: projects(:one), variable_id: variables(:date), value: { month: '2', day: '31', year: '2000' }, format: 'json'
  ...
  test 'should validate return inside hard range for variable' do
    xhr :post, :variable, project_id: projects(:one), variable_id: variables(:date), value: { month: '6', day: '15', year: '1995' }, format: 'json'
