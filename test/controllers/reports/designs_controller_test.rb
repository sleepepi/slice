...
class Reports::DesignsControllerTest < ActionController::TestCase
  ...
  test 'should get advanced report before sheet date as viewer' do
    login(@viewer)
    post :advanced_report, params: { project_id: @project, id: @design, sheet_before: '10/18/2012' }
    assert_not_nil assigns(:design)
    assert_response :success
  end
  ...
  test 'should get advanced report after sheet date as viewer' do
    login(@viewer)
    post :advanced_report, params: { project_id: @project, id: @design, sheet_after: '10/01/2012' }
    assert_not_nil assigns(:design)
    assert_response :success
  end
  ...
  test 'should get advanced report between sheet date as viewer' do
    login(@viewer)
    post :advanced_report, params: { project_id: @project, id: @design, sheet_after: '10/01/2012', sheet_before: '10/18/2012' }
    assert_not_nil assigns(:design)
    assert_response :success
  end
  ...
  test 'should get advanced report by week as viewer' do
    login(@viewer)
    post :advanced_report, params: { project_id: @project, id: @design, by: 'week' }
    assert_not_nil assigns(:design)
    assert_response :success
  end
  ...
  test 'should get advanced report by year as viewer' do
    login(@viewer)
    post :advanced_report, params: { project_id: @project, id: @design, by: 'year' }
    assert_not_nil assigns(:design)
    assert_response :success
  end
  ...
  test 'should get advanced report with row variable (dropdown) as viewer' do
    login(@viewer)
    post :advanced_report, params: { project_id: @project, id: @design, f: [{ id: variables(:one).id, axis: 'row', missing: '1' }] }
    assert_not_nil assigns(:design)
    assert_response :success
  end
  ...
  test 'should get advanced report with row variable (dropdown) and exclude missing as viewer' do
    login(@viewer)
    post :advanced_report, params: { project_id: @project, id: @design, f: [{ id: variables(:one).id, axis: 'row', missing: '0' }] }
    assert_not_nil assigns(:design)
    assert_response :success
  end
  ...
  test 'should get advanced report with column variable (dropdown) as viewer' do
    login(@viewer)
    post :advanced_report, params: { project_id: @project, id: @design, f: [{ id: variables(:one).id, axis: 'col', missing: '1' }] }
    assert_not_nil assigns(:design)
    assert_response :success
  end
