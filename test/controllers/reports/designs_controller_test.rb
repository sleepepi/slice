...
class Reports::DesignsControllerTest < ActionController::TestCase
  ...
  test 'should show design overview as viewer' do
    login(@viewer)
    get :overview, project_id: @project, id: designs(:all_variable_types)
  ...
  test 'should show design overview for design with sections as viewer' do
    login(@viewer)
    get :overview, project_id: @project, id: designs(:sections_and_variables)
    assert_not_nil assigns(:project)
    assert_not_nil assigns(:design)
    assert_response :success
  end
  ...
  test 'should get advanced report as viewer' do
    login(@viewer)
    get :advanced, project_id: @project, id: @design
    assert_not_nil assigns(:design)
    assert_response :success
  end
  ...
  test 'should get advanced report before sheet date as viewer' do
    login(@viewer)
    get :advanced, project_id: @project, id: @design, sheet_before: '10/18/2012'
    assert_not_nil assigns(:design)
    assert_response :success
  end
  ...
  test 'should get advanced report after sheet date as viewer' do
    login(@viewer)
    get :advanced, project_id: @project, id: @design, sheet_after: '10/01/2012'
    assert_not_nil assigns(:design)
    assert_response :success
  end
  ...
  test 'should get advanced report between sheet date as viewer' do
    login(@viewer)
    get :advanced, project_id: @project, id: @design, sheet_after: '10/01/2012', sheet_before: '10/18/2012'
    assert_not_nil assigns(:design)
    assert_response :success
  end
  ...
  test 'should get advanced report by week as viewer' do
    login(@viewer)
    get :advanced, project_id: @project, id: @design, by: 'week'
    assert_not_nil assigns(:design)
    assert_response :success
  end
  ...
  test 'should get advanced report by year as viewer' do
    login(@viewer)
    get :advanced, project_id: @project, id: @design, by: 'year'
    assert_not_nil assigns(:design)
    assert_response :success
  end
  ...
  test 'should get advanced report with row variable (dropdown) as viewer' do
    login(@viewer)
    get :advanced, project_id: @project, id: @design, f: [{ id: variables(:one).id, axis: 'row', missing: '1' }]
    assert_not_nil assigns(:design)
    assert_response :success
  end
  ...
  test 'should get advanced report with row variable (dropdown) and exclude missing as viewer' do
    login(@viewer)
    get :advanced, project_id: @project, id: @design, f: [{ id: variables(:one).id, axis: 'row', missing: '0' }]
    assert_not_nil assigns(:design)
    assert_response :success
  end
  ...
  test 'should get advanced report with column variable (dropdown) as viewer' do
    login(@viewer)
    get :advanced, project_id: @project, id: @design, f: [{ id: variables(:one).id, axis: 'col', missing: '1' }]
    assert_not_nil assigns(:design)
    assert_response :success
  end
  ...
  test 'should get advanced report with column variable (numeric) as viewer' do
    login(@viewer)
    get :advanced, project_id: @project, id: designs(:all_variable_types),
  ...
  test 'should get advanced report gender (row) by weight (column) as viewer' do
    login(@viewer)
    get :advanced, project_id: @project, id: designs(:weight_and_gender),
                   f: [
  ...
  test 'should get advanced report as a CSV as viewer' do
    login(@viewer)
    get :advanced, project_id: @project, id: @design, format: 'csv'
    assert_not_nil assigns(:design)
    assert_response :success
  end
  ...
  test 'should not get report for invalid design as viewer' do
    login(@viewer)
    get :advanced, project_id: @project, id: -1
  ...
  test 'should not get report with invalid project as viewer' do
    login(@viewer)
    get :advanced, project_id: -1, id: @design
  ...
  test 'should show advanced report if PDF fails to render as viewer' do
    ...
    begin
      ...
      login(@viewer)
      get :advanced, project_id: @project, id: designs(:has_no_validations), format: 'pdf'
      assert_not_nil assigns(:project)
      assert_not_nil assigns(:design)
