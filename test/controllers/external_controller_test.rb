...
class ExternalControllerTest < ActionController::TestCase
  ...
  test 'should add grid row as valid user' do
    login(users(:valid))
    post :add_grid_row, design: designs(:has_grid), variable_id: variables(:grid), design_option_id: design_options(:has_grid_grid), format: 'js'
  ...
  test 'should add grid row on public survey' do
    post :add_grid_row, design: designs(:admin_public_design), variable_id: variables(:external_grid), design_option_id: design_options(:admin_public_design_external_grid), sheet_authentication_token: sheets(:external).authentication_token, format: 'js'
    assert_not_nil assigns(:variable)
    assert_template 'add_grid_row'
    assert_response :success
  end
  ...
  test 'should add grid for handoff' do
    post :add_grid_row, design: designs(:has_grid), variable_id: variables(:grid), design_option_id: design_options(:has_grid_grid), handoff: handoffs(:grid), format: 'js'
    assert_not_nil assigns(:variable)
    assert_template 'add_grid_row'
    assert_response :success
  end
  ...
  test 'should format number as valid user' do
    login(users(:valid))
    xhr :get, :format_number, design: designs(:all_variable_types), variable_id: variables(:calculated), calculated_number: '25.359', format: 'js'
    assert_not_nil assigns(:variable)
  ...
  test 'should format number on public survey' do
    xhr :get, :format_number, design: designs(:admin_public_design), variable_id: variables(:external_calculated), calculated_number: '25.359', format: 'js'
    assert_not_nil assigns(:variable)
    assert_equal '25.36', assigns(:result)
    assert_template 'format_number'
  end
  ...
  test 'should format number for handoff' do
    xhr :get, :format_number, design: designs(:all_variable_types), variable_id: variables(:calculated), handoff: handoffs(:calculated), calculated_number: '25.359', format: 'js'
    assert_not_nil assigns(:variable)
    assert_equal '25.36', assigns(:result)
    assert_template 'format_number'
  end
  ...
  test 'should get typeahead as valid user' do
    login(users(:valid))
    get :typeahead, design: designs(:all_variable_types), variable_id: variables(:autocomplete), format: 'js'
    assert_not_nil assigns(:variable)
  ...
  test 'should get typeahead for public survey' do
    get :typeahead, design: designs(:admin_public_design), variable_id: variables(:public_autocomplete), format: 'js'
    assert_not_nil assigns(:variable)
    assert_equal ['Cat', 'Dog', 'Fish'], assigns(:variable).autocomplete_array
    assert_response :success
  end
  ...
  test 'should get blank array for non-string typeahead' do
    login(users(:valid))
    get :typeahead, design: designs(:all_variable_types), variable_id: variables(:dropdown), format: 'js'
    assert_not_nil assigns(:variable)
  ...
  test 'should get typeahead for handoff' do
    get :typeahead, design: designs(:all_variable_types), variable_id: variables(:autocomplete), handoff: handoffs(:typeahead), format: 'js'
    assert_not_nil assigns(:variable)
    assert_equal ['Cat', 'Dog', 'Fish'], assigns(:variable).autocomplete_array
    assert_response :success
  end
  ...
  test 'should get section image from public design as public viewer' do
    get :section_image, section_id: @public_section.id, design: @public_design
  ...
  test 'should get section image from handoff' do
    ...
    get :section_image, section_id: @section.id, design: @design, handoff: @handoff
  ...
  test 'should get section image from design as valid user' do
    login(users(:valid))
    get :section_image, section_id: @private_section.id, design: @private_design
