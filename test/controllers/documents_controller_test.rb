...
# Tests the project editors can view and modify project documents
class DocumentsControllerTest < ActionController::TestCase
  ...
  test 'should download document file' do
    ...
    get :file, params: { id: @document, project_id: @project }
  ...
  test 'should not download empty document file' do
    ...
    get :file, params: { id: documents(:two), project_id: @project }
    assert_not_nil assigns(:project)
    assert_not_nil assigns(:document)
  ...
  test 'should show document' do
    get :show, params: { id: @document, project_id: @project }
    assert_not_nil assigns(:document)
    assert_response :success
  end

  test 'should not show document with invalid project' do
    get :show, params: { id: @document, project_id: -1 }
    assert_nil assigns(:document)
    assert_redirected_to root_path
  end

  test 'should get edit' do
    get :edit, params: { id: @document, project_id: @project }
    assert_not_nil assigns(:document)
    assert_response :success
  end

  test 'should not get edit with invalid project' do
    get :edit, params: { id: @document, project_id: -1 }
    assert_nil assigns(:document)
    assert_redirected_to root_path
  end
  ...
  test 'should destroy document' do
    assert_difference('Document.current.count', -1) do
      delete :destroy, params: { id: @document, project_id: @project }
    end
    assert_not_nil assigns(:document)
    assert_not_nil assigns(:project)
  ...
  test 'should not destroy document with invalid project' do
    assert_difference('Document.current.count', 0) do
      delete :destroy, params: { id: @document, project_id: -1 }
    end
    assert_nil assigns(:document)
    assert_nil assigns(:project)
    assert_redirected_to root_path
