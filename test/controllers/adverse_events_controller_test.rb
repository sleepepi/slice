...
class AdverseEventsControllerTest < ActionController::TestCase
  ...
  test "should get index ordered by reported by" do
    login(users(:valid))
    get :index, params: { project_id: @project, order: "reported_by" }
    assert_response :success
    assert_not_nil assigns(:adverse_events)
  end
  ...
  test "should get index ordered by reported by desc" do
    login(users(:valid))
    get :index, params: { project_id: @project, order: "reported_by desc" }
    assert_response :success
    assert_not_nil assigns(:adverse_events)
  end
  ...
  test "should show adverse event as project editor" do
    login(users(:valid))
    get :show, params: { project_id: @project, id: @adverse_event }
    assert_response :success
  end
  ...
  test "should get adverse event forms as project editor" do
    login(users(:valid))
    get :forms, params: { project_id: @project, id: @adverse_event }
    assert_response :success
  end
  ...
  test "should get edit as project editor" do
    login(users(:valid))
    get :edit, params: { project_id: @project, id: @adverse_event }
    assert_response :success
  end
  ...
  test "should update adverse event as project editor" do
    login(users(:valid))
    patch :update, params: {
      project_id: @project, id: @adverse_event,
      adverse_event: {
