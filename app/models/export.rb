class Export < ActiveRecord::Base
  ...
  private
    ...
    def generate_r(sheet_scope, filename)
      ...
      erb_file = File.join('app', 'views', 'exports', "export.r.erb")
      export_file = File.join('tmp', 'files', 'exports', "#{filename}_r.r")
      ...
      [["R/#{export_file.split('/').last}", export_file], generate_readme('r')]
    end
