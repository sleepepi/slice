class SchedulesController < ApplicationController
  ...
  before_action :set_editable_project, only: [ :index, :show ]
  before_action :redirect_without_project, only: [ :index, :show ]
  before_action :set_schedule, only: [ :show ]
  before_action :redirect_without_schedule, only: [ :show ]
