...
@buildSectionFormData = ->
  ...
  formData.append("section[image]", $("#section_image").prop("files")[0]) if $("#section_image").prop("files")[0]?
  formData.append("section[remove_image]", '1') if $("#section_remove_image").is(":checked")
