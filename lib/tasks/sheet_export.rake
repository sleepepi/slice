...
/*  YOU WILL NEED TO MODIFY IMPORT FOLDER TO   */
/* POINT TO THE LOCATION WHERE YOU DOWNLOADED  */
/*            THE CSV AND SAS FILES            */
...
data _null_;
  ...
  file "&import_folder.\\&import_file._sas.csv" recfm=n;
  input a $char1.;
  retain open 0;
...
data slice;
  infile "&import_folder.\\&import_file._sas.csv" delimiter = ',' MISSOVER DSD lrecl=32767 firstobs=2 ;
