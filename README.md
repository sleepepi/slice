...
```
SHELL=/bin/bash
0 1 * * * source /etc/profile.d/rvm.sh && cd /var/www/slice && /usr/local/rvm/gems/ruby-2.1.4/bin/bundle exec rake daily_digest RAILS_ENV=production
```
