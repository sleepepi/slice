class AddPrincipalToAssignmentPathwayIndex < ActiveRecord::Migration[5.2]
  def up
    ...
    add_index :ae_adverse_event_reviewer_assignments, [:ae_adverse_event_id, :ae_review_team_id, :ae_team_pathway_id, :reviewer_id, :principal], unique: true, name: "idx_team_assignment_pathway"
  end
